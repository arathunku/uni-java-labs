...
public class Student { 
	private final static int MIN_BIRTH = 1980;
	private final static int MAX_BIRTH = 2004;
	private final static double MIN_WEIGHT =  3.0;
	private final static double MAX_WEIGHT =  140.0;
	private final static int MIN_STUDY_YEAR =  1;
	private final static int MAX_STUDY_YEAR =  8;
